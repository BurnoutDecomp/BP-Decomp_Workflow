...
>> "%RSP%" (
  ...
  echo "%VEN%\dirtysdk\src\dirtyaddr.cpp"
  echo "%VEN%\dirtysdk\src\dirtylib.cpp"
  echo "%VEN%\dirtysdk\src\dirtymem.cpp"
  echo "%VEN%\dirtysdk\src\dirtynet.cpp"
  echo "%VEN%\dirtysdk\src\lobbyapiutil.cpp"
  echo "%VEN%\dirtysdk\src\lobbydisplist.cpp"
  echo "%VEN%\dirtysdk\src\lobbysort.cpp"
  echo "%VEN%\dirtysdk\src\lobbytagfield.cpp"
  echo "%VEN%\dirtysdk\src\pc\connapipc.cpp"
  echo "%VEN%\dirtysdk\src\pc\gamemanagerpc.cpp"
  echo "%VEN%\dirtysdk\src\pc\hlbudapipc.cpp"
  echo "%VEN%\dirtysdk\src\pc\lan\pclan_core.cpp"
  echo "%VEN%\dirtysdk\src\pc\lan\pclan_link.cpp"
  echo "%VEN%\dirtysdk\src\pc\lan\pclan_lobby.cpp"
  echo "%VEN%\dirtysdk\src\pc\lobbyapipc.cpp"
  echo "%VEN%\dirtysdk\src\pc\lobbyloginpc.cpp"
  echo "%VEN%\dirtysdk\src\pc\lobbymiscpc.cpp"
  echo "%VEN%\dirtysdk\src\pc\netconnpc.cpp"
  echo "%VEN%\dirtysdk\src\pc\netgamelinkpc.cpp"
  echo "%VEN%\dirtysdk\src\pc\pingmanagerpc.cpp"
  echo "%VEN%\dirtysdk\src\pc\protopc.cpp"
  echo "%VEN%\dirtysdk\src\pc\telemetryapipc.cpp"
  echo "%VEN%\dirtysdk\src\pc\voippc.cpp"
  echo "%VEN%\dirtysdk\src\plat-str.cpp"
  echo "%VEN%\dirtysdk\src\plat-time.cpp"
  echo "%VEN%\dirtysdk\src\protomangle.cpp"
  ...
  echo "%VEN%\renderware\src\rw\audio\core\Route.cpp"
...
echo "%SRC%\GameShared\GameClasses\Sound\Playback\AEMS\CgsAemsContent.cpp"
echo "%SRC%\GameShared\GameClasses\Sound\Playback\AEMS\CgsAemsContentDtor.cpp"
echo "%SRC%\GameShared\GameClasses\Sound\Playback\AEMS\CgsAemsPlayerVoice.cpp"
echo "%SRC%\GameShared\GameClasses\Sound\Playback\AEMS\CgsAemsPlayerVoiceNew.cpp"
echo "%SRC%\GameShared\GameClasses\Sound\Playback\AEMS\CgsAemsPlayerVoiceDtor.cpp"
echo "%SRC%\GameShared\GameClasses\Sound\Playback\CgsCommandQueue.cpp"
echo "%SRC%\GameShared\GameClasses\Sound\Playback\AEMS\CgsCsisCommandQueue.cpp"
echo "%SRC%\SDKs\EATech\include\snd\sndaems.cpp"
echo "%SRC%\SDKs\Csis\CsisClass.cpp"
echo "%SRC%\SDKs\Csis\CsisClassData.cpp"
echo "%SRC%\SDKs\Csis\CsisClassHandle.cpp"
echo "%SRC%\SDKs\Csis\CsisFunction.cpp"
echo "%SRC%\SDKs\Csis\CsisFunctionHandle.cpp"
echo "%SRC%\SDKs\Csis\CsisGlobalVariable.cpp"
echo "%SRC%\SDKs\Csis\CsisGlobalVariableHandle.cpp"
  echo "%SRC%\SDKs\EATech\include\snd\sndaems_linkclosure.cpp"
  echo "%SRC%\GameShared\GameClasses\System\PC\CgsMovieStreamHeaderLookup.cpp"
  ...
  echo "%SRC%\GameSource\World\AI\RacingLine\BrnRacingLineGenerator.cpp"
  echo "%SRC%\GameSource\World\AI\RacingLine\BrnRacingLineGenerator_Query.cpp"
  echo "%SRC%\GameSource\World\AI\RacingLine\BrnRacingLineGenerator_Curve.cpp"
  echo "%SRC%\GameSource\World\AI\RacingLine\BrnHardNoGoMap.cpp"
  ...
  echo "%SRC%\GameSource\World\AI\RacingLine\BrnAISteeringFan_Target.cpp"
  echo "%SRC%\GameSource\World\AI\RacingLine\BrnAISteeringFan_Weightings.cpp"
  echo "%SRC%\GameSource\World\AI\RacingLine\BrnAISteeringFan_HNG.cpp"
  echo "%SRC%\GameSource\World\AI\RacingLine\BrnAISteeringFan_Traffic.cpp"
  echo "%SRC%\GameSource\World\AI\RacingLine\BrnAISteeringFan_Aggression.cpp"
  ...
  echo "%SRC%\GameSource\Effects\BrnEffectsUtils.cpp"
  echo "%SRC%\GameSource\Effects\BrnEffectsDebrisColourRandomiser.cpp"
  echo "%SRC%\GameSource\Effects\BrnEffectsBuildUVData.cpp"
  ...
  rem ---- DEBRIS PRODUCER (2026-09-11). ParticleModule::SpawnDebris -- the update-thread end of
  rem   the debris chain, and the reason no debris ever spawned: every other link existed.
  rem   JumpStateMachine::FireWheelDebris is unparked in the same change and calls it.
  echo "%SRC%\GameSource\Effects\Particles\ParticleModule_DebrisSpawn.cpp"
  ...
  rem  ICEFile.cpp is whole again: its FileClose half, split out on 2026-08-01 because it is
  rem  the ICE package's sole EA::GameTalk user, was folded back in when that stack landed.
  ...
  rem  (988 insns) in its own slice TU; its home TU BrnVehicleManager.cpp is mounted too.
  rem  Every constant image-read (cull height 0.4; wall-normal
  ...
  rem  ProcessDeformationStates) -- slice TU; its home TU BrnVehicleManager.cpp is mounted too.
...
echo "%SRC%\GameSource\Physics\VehicleManager\BrnVehicleManager_PrepareData.cpp"
  ...
  rem  real here; its five arms + the traffic twin are real bodies too (re-measured 2026-09-11).
  ...
  rem  create queue is drained, not counted. Slice TU; its home TU BrnVehicleManager.cpp is mounted too.
  ...
  rem  LineTestsResults / ProcessAftertouchEvents) -- slice TU; its home TU BrnVehicleManager.cpp
  rem  is mounted too.
  ...
  rem  THIS MOUNT IS MANDATORY, NOT OPTIONAL: its caller (BrnPhysicsModuleUpdateFunctions.cpp's
  rem  driver stage) is mounted and live, so without this line the build loses the symbol
  rem  outright (LNK2019). Its own link closure is already here: the five dispatch arms
  rem  (UpdatePlayer/AI/NetworkDriver, PhysicalTrafficManager::UpdateTrafficDriver,
  rem  DoHornTakedowns) are ALL REAL BODIES in the two TUs mounted just below -- re-measured
  rem  2026-09-11; this rem used to call them 1,346 instructions of BODYLESS named gates.
  ...
  rem  all five are real bodies, and UpdateDrivers above is live every frame, so BOTH mounts
  rem  are mandatory (LNK2019 otherwise). DoHornTakedowns
  rem  -> InstantTakedown, split into its own slice TU below; InstantTakedown's callee
  rem  SetRaceCarCrashing is a real body in the mounted BrnVehicleManager.cpp (re-measured
  rem  2026-09-11 -- this rem used to route it to a loud trap in a stub TU that no longer
  rem  exists).
  ...
  rem  The network crash-state stage + its SetNetworkCarCrashing sink; retires the last conductor gate (2026-09-11).
  echo "%SRC%\GameSource\Physics\VehicleManager\BrnVehicleManager_ProcessCrashingNetworkCars.cpp"
  ...
  rem  THE WALL THAT USED TO SIT HERE IS GONE: this rem named VehicleManager::UpdatePlayerDriver
  rem  as a conductor gate where the player's controls record stopped, leaving the orchestrator
  rem  running on an all-zero record. It is a real body in the mounted BrnVehicleManager_DriverArms.cpp.
...
echo "%SRC%\GameSource\Physics\VehicleManager\BrnPhysicalTrafficManager_TrafficEvents.cpp"
  ...
  rem  OutputData conductor gate was deleted by the same commit.
  ...
  rem   AND THE MOUNT'S RUNTIME PRECONDITIONS, re-measured 2026-09-11: the precondition this rem
  rem     carried -- "degrade the DoRaceCarWorldContactGeneration / DoCarCarContactGeneration
  rem     TRAP STUBS to log-once gates FIRST or they assert-storm" -- is spent; both are real
  rem     bodies in the mounted BrnVehicleManagerContactGeneration.cpp. Still true: BrnPhysicsModule.cpp
  rem     Prepare stage 4's fourteen deferred deformation-IO clears become live the same moment.
  rem  RETIRED 2026-09-11: a link-closure census stood here, headed "BrnVehicleManager.cpp IS
  rem  STILL NOT MOUNTED", tabulating three trial links (M1/M2/M3), twelve unresolved externals
  rem  it owned, and a verdict that the wave ahead of it was the TrafficPhysics de-fork. Every one
  rem  of those conditions is discharged: the de-fork landed, all twelve symbols have bodies in
  rem  mounted TUs, and BrnVehicleManager.cpp is mounted above. Do not re-quote the old census.
  ...
  echo "%SRC%\GameSource\World\CrashModule\BrnCrashModule_TrafficCrashes.cpp"
...
rem  2026-09-14 (traffic-type wave): ProcessTrafficTypeRequests @0x8272B880 -- an ARTIST
rem  EXPORT HOLE, read out of the image with tools/re/ppcdis.py. It is the ONLY producer of
rem  TrafficTypeResponse, i.e. the only input TakedownManager::GetTakedownTypeFromTrafficVehicleIndex
...
echo "%SRC%\GameSource\World\EntityModules\TrafficEntityModule\Array_short_9.cpp"
  ...
  echo "%SRC%\GameSource\Network\SharedIO\BrnNetworkModuleStatsIOInterface.cpp"
  echo "%SRC%\GameSource\Network\SharedIO\BrnNetworkOutScoreboardHeadingList.cpp"
  ...
  echo "%SRC%\GameSource\Sound\Collision\BrnCollisionFrameInformation.cpp"
  ...
  echo "%SRC%\GameSource\Sound\Module\LogicModule\BrnEmitterState.cpp"
  echo "%SRC%\GameSource\Sound\Module\LogicModule\BrnEmitter3dControl.cpp"
  echo "%SRC%\GameSource\Sound\World\BrnEmitterEffect.cpp"
  ...
  echo "%SRC%\GameSource\Sound\Vehicles\Brn3dCarPosition.cpp"
  echo "%SRC%\GameSource\Sound\Module\LogicModule\Brn3DEffectControl.cpp"
  echo "%SRC%\GameSource\Sound\Vehicles\Engines\BrnPhysicsControl.cpp"
  echo "%SRC%\GameSource\Sound\Vehicles\Engines\BrnShiftControl.cpp"
  echo "%SRC%\GameSource\Sound\Vehicles\Engines\BrnClutchControl.cpp"
  echo "%SRC%\GameSource\Sound\Vehicles\Engines\BrnEngineControl.cpp"
  echo "%SRC%\GameSource\Sound\Vehicles\Engines\BrnHybridExhaustControl.cpp"
  echo "%SRC%\GameSource\Sound\Vehicles\Engines\BrnHybridEngineControl.cpp"
  echo "%SRC%\GameSource\Sound\Vehicles\Engines\BrnDualGinsuEffect.cpp"
  echo "%SRC%\GameSource\Sound\Vehicles\Deformation\BrnDeformationEffect.cpp"
  echo "%SRC%\SharedClasses\Sound\Engines\BrnSoundLoopModelData.cpp"
  echo "%SRC%\SharedClasses\Sound\Engines\BrnSoundLoopModelResourceType.cpp"
  echo "%SRC%\GameSource\Sound\Vehicles\Engines\BrnDualGinsuExhaustEffect.cpp"
  echo "%SRC%\GameSource\Sound\Vehicles\Engines\BrnBoostEffect.cpp"
  echo "%SRC%\GameSource\Sound\Vehicles\Engines\BrnTurboEffect.cpp"
  echo "%SRC%\GameSource\Sound\Vehicles\Engines\BrnWhineEffect.cpp"
  echo "%SRC%\GameSource\Sound\Vehicles\Engines\BrnSweetenersEffect.cpp"
  echo "%SRC%\GameSource\Sound\Vehicles\Wheels\BrnWheelControl.cpp"
  echo "%SRC%\GameSource\Sound\Vehicles\Wheels\BrnSkidEffect.cpp"
  echo "%SRC%\GameSource\Sound\Vehicles\Wheels\BrnRoadNoise.cpp"
  echo "%SRC%\GameSource\Sound\Vehicles\Wheels\BrnInAirEffect.cpp"
  echo "%SRC%\GameSource\Sound\Vehicles\Environment\BrnEnclosureControl.cpp"
  echo "%SRC%\GameSource\Sound\Vehicles\Environment\BrnStaticPassbyControl.cpp"
  echo "%SRC%\GameSource\Sound\Vehicles\Environment\BrnSpeedStreamControl.cpp"
  echo "%SRC%\GameSource\Sound\Vehicles\Environment\BrnAmbienceControl.cpp"
  echo "%SRC%\GameSource\Sound\Vehicles\Environment\BrnCrashStreamEffect.cpp"
  echo "%SRC%\GameSource\Sound\Vehicles\Environment\BrnSpeedStreamEffect.cpp"
  echo "%SRC%\GameSource\Sound\Vehicles\Environment\BrnAmbienceEffect.cpp"
  echo "%SRC%\GameSource\Sound\Vehicles\Environment\BrnReverbEffect.cpp"
  ...
  echo "%SRC%\GameSource\Sound\Streaming\BrnStreamingState.cpp"
  echo "%SRC%\GameSource\Sound\Streaming\BrnStreamingEffect.cpp"
  echo "%SRC%\GameSource\Sound\Module\LogicModule\BrnState.cpp"
  echo "%SRC%\GameSource\Sound\Module\LogicModule\BrnEffectObject.cpp"
  echo "%SRC%\GameSource\Sound\Module\LogicModule\BrnEffectControl.cpp"
  echo "%SRC%\GameSource\Sound\Module\LogicModule\BrnSubmixesEffect.cpp"
  ...
  echo "%SRC%\GameSource\Sound\Collision\BrnCollisionEffect.cpp"
  echo "%SRC%\GameSource\Sound\Collision\BrnScrapeEffect.cpp"
  echo "%SRC%\GameSource\Sound\Module\LogicModule\Brn3DUserSpaceEffectControl.cpp"
  echo "%SRC%\GameSource\Sound\Global\BrnGlobalStateManager.cpp"
  echo "%SRC%\GameSource\Sound\Global\BrnGlobalState.cpp"
  echo "%SRC%\GameSource\Sound\Global\BrnMusicEffect.cpp"
  echo "%SRC%\GameSource\Sound\Global\BrnMusicStream.cpp"
  echo "%SRC%\GameSource\Sound\Global\BrnPresentationEffect.cpp"
  echo "%SRC%\GameSource\Sound\Global\BrnSpeechEffect.cpp"
  echo "%SRC%\GameSource\Sound\Global\BrnHUDEffect.cpp"
  echo "%SRC%\GameSource\Sound\Global\BrnFxEffect.cpp"
  echo "%SRC%\GameSource\Sound\Global\BrnMixerControl.cpp"
  echo "%SRC%\GameSource\Sound\Global\BrnCameraControl.cpp"
  echo "%SRC%\GameSource\Sound\Vehicles\Wheels\BrnJunkyardInAirEffect.cpp"
  ...
  echo "%SRC%\GameShared\GameClasses\Sound\Logic\CgsVoiceWrapper.cpp"
  echo "%SRC%\GameShared\GameClasses\Sound\Logic\CgsVoicePool.cpp"
  echo "%SRC%\GameShared\GameClasses\Sound\Logic\CgsContent.cpp"
  ...
  echo "%SRC%\GameShared\GameClasses\System\AttribSys\CgsAttribSysDebugComponent.cpp"
  echo "%SRC%\GameSource\GameState\BrnResetPlayerDebugComponent.cpp"
  ...
  echo "%SRC%\GameShared\GameClasses\Network\Packeting\Messages\CgsReliableMessage.cpp"
  echo "%SRC%\GameShared\GameClasses\Network\Packeting\Messages\CgsMessageWithPlayerIDs.cpp"
  echo "%SRC%\GameShared\GameClasses\Network\Packeting\Messages\CgsMessageSubclasses.cpp"
  echo "%SRC%\GameShared\GameClasses\Network\Packeting\Messages\CgsMessageFrameUtils.cpp"
  echo "%SRC%\GameShared\GameClasses\Network\Packeting\Messages\CgsMessage_wN1_01.cpp"
  echo "%SRC%\GameShared\GameClasses\Network\Packeting\Messages\CgsOldFrameConversionFunctions.cpp"
  ...
  echo "%SRC%\GameShared\GameClasses\Sound\Logic\Cgs3dEffectControl.cpp"
  echo "%SRC%\GameShared\GameClasses\Sound\Logic\CgsEffectBase.cpp"
  ...
  rem ---- PHASE F: serialized sound-registry entity fixers -------------------
  echo "%SRC%\GameShared\GameClasses\Sound\Playback\CgsDataStructures.cpp"
  echo "%SRC%\GameShared\GameClasses\Sound\Playback\AEMS\CgsAemsDataStructures.cpp"
  echo "%SRC%\GameShared\GameClasses\Sound\Playback\CgsContentSpecFixer.cpp"
  echo "%SRC%\GameShared\GameClasses\Sound\Playback\CgsFeatureSchema.cpp"
  echo "%SRC%\GameShared\GameClasses\Sound\Playback\CgsFeatureSchemaFixer.cpp"
  echo "%SRC%\GameShared\GameClasses\Sound\Playback\CgsParameterSchemaFixer.cpp"
  echo "%SRC%\GameShared\GameClasses\Sound\Playback\CgsSlotSchema.cpp"
  echo "%SRC%\GameShared\GameClasses\Sound\Playback\CgsVoiceSchema.cpp"
  echo "%SRC%\GameShared\GameClasses\Sound\Playback\CgsVoiceSchemaFixer.cpp"
  echo "%SRC%\GameShared\GameClasses\Sound\Playback\CgsVoiceSpec.cpp"
...
echo "%SRC%\GameShared\GameClasses\Sound\Playback\CgsContentDtor.cpp"
echo "%SRC%\GameShared\GameClasses\Sound\Playback\CgsContentOnDetach.cpp"
echo "%SRC%\GameShared\GameClasses\Sound\Playback\RWAC\CgsContentLoader.cpp"
echo "%SRC%\GameShared\GameClasses\Sound\Playback\RWAC\CgsGenericRwacWaveContent.cpp"
echo "%SRC%\GameShared\GameClasses\Sound\Playback\RWAC\CgsGenericRwacWaveContentDtor.cpp"
echo "%SRC%\GameShared\GameClasses\Sound\Playback\RWAC\CgsGenericRwacReverbIRContent.cpp"
echo "%SRC%\GameShared\GameClasses\Sound\Playback\RWAC\CgsGenericRwacCommands.cpp"
echo "%SRC%\GameShared\GameClasses\Sound\Playback\RWAC\CgsGenericRwacVoiceConfig.cpp"
echo "%SRC%\GameShared\GameClasses\Sound\Playback\RWAC\CgsGenericRwacVoice.cpp"
echo "%SRC%\GameShared\GameClasses\Sound\Playback\RWAC\CgsGenericRwacPlayerVoice.cpp"
echo "%SRC%\GameShared\GameClasses\Sound\Playback\RWAC\CgsGenericRwacSubmixVoice.cpp"
echo "%SRC%\GameShared\GameClasses\Sound\Playback\RWAC\CgsGenericRwacMasterVoice.cpp"
  echo "%SRC%\GameShared\GameClasses\Sound\Playback\CgsFactory.cpp"
  echo "%SRC%\GameShared\GameClasses\Sound\Playback\CgsVoice.cpp"
  echo "%SRC%\GameShared\GameClasses\Sound\Playback\CgsSubmixVoiceDtor.cpp"
  echo "%SRC%\GameShared\GameClasses\Sound\Playback\CgsMasterVoice.cpp"
  ...
  echo "%SRC%\GameShared\GameClasses\Sound\Playback\CgsRegistryResourceType.cpp"
  echo "%SRC%\GameShared\GameClasses\Sound\Playback\RWAC\CgsGenericRwacWaveContentResourceType.cpp"
  echo "%SRC%\GameShared\GameClasses\Sound\Playback\RWAC\CgsGenericRwacReverbIRContentResourceType.cpp"
  echo "%SRC%\GameShared\GameClasses\Sound\Playback\Plugins\Ginsu\CgsGinsuWaveContentResourceType.cpp"
  echo "%SRC%\GameShared\GameClasses\Sound\Playback\AEMS\CgsAemsBankResourceType.cpp"
  echo "%SRC%\GameShared\GameClasses\Sound\Playback\CSIS\CgsCsisResourceType.cpp"
  echo "%SRC%\GameShared\GameClasses\Sound\Playback\Splicer\CgsSplicerResourceType.cpp"
  echo "%SRC%\GameShared\GameClasses\Sound\Logic\CgsNicotineResourceType.cpp"
  echo "%SRC%\GameShared\GameClasses\Sound\Logic\CgsSnapshotDataResourceType.cpp"
  ...
  echo "%SRC%\GameShared\GameClasses\Sound\Playback\Splicer\CgsSplicerContent.cpp"
  echo "%SRC%\GameShared\GameClasses\Sound\Playback\Splicer\CgsSplicerContentDtor.cpp"
  echo "%SRC%\GameShared\GameClasses\Sound\Playback\Splicer\CgsSpliceBankStatistics.cpp"
  echo "%SRC%\GameShared\GameClasses\Sound\Playback\Splicer\SpliceManager.cpp"
  echo "%SRC%\GameShared\GameClasses\Sound\Playback\Splicer\internal\SpliceObjects.cpp"
  echo "%SRC%\GameShared\GameClasses\Sound\Playback\Splicer\CgsSplicerPlayerVoice.cpp"
  ...
  echo "%SRC%\SDKs\Packages\ICE\ICEAuthorParamOps.cpp"
  echo "%SRC%\SDKs\Packages\ICE\ICEAuthorSegmentOps.cpp"
  echo "%SRC%\SDKs\Packages\ICE\ICEAuthorSpaceOps.cpp"
  echo "%SRC%\SDKs\Packages\ICE\ICECamera.cpp"
  echo "%SRC%\SDKs\Packages\ICE\ICECameraSpaceHandlerCtor.cpp"
  echo "%SRC%\SDKs\Packages\ICE\ICEController.cpp"
  echo "%SRC%\SDKs\Packages\ICE\ICEControllerBubble.cpp"
  echo "%SRC%\SDKs\Packages\ICE\ICEControllerEditOps.cpp"
  echo "%SRC%\SDKs\Packages\ICE\ICEControllerMenus.cpp"
  echo "%SRC%\SDKs\Packages\ICE\ICEControllerRender.cpp"
  echo "%SRC%\SDKs\Packages\ICE\ICEMemoryList.cpp"
  echo "%SRC%\SDKs\Packages\ICE\ICERender.cpp"
  echo "%SRC%\SDKs\Packages\ICE\ICEWidget\ICEWidgetIcon.cpp"
  echo "%SRC%\SDKs\Packages\ICE\ICEWidget\ICEWidgetInfoList.cpp"
  echo "%SRC%\SDKs\Packages\ICE\ICEWidget\ICEWidgetLogo.cpp"
  echo "%SRC%\SDKs\Packages\ICE\ICEWidget\ICEWidgetMenu.cpp"
  echo "%SRC%\SDKs\Packages\ICE\ICEWidget\ICEWidgetMenuItem.cpp"
  ...
  rem ---- [momentstunt] 2026-09-11: BrnMomentPlayerStunt.cpp measures ZERO non-CRT unresolved
  rem  and zero hard duplicates. Its last external, DirectorResourceManager::GetKeyAnim(ID),
  rem  is bodied in the already-mounted BrnDirectorResourceManagerICE.cpp -- the park note
  ...
  rem  BrnShotSelector.cpp joins with it, 2026-09-11: measured alone against the whole object
  rem  list it opens ZERO unresolved externals and zero non-COMDAT duplicates, and it is the
  ...
  rem  BrnBehaviourManager.cpp includes. All three class-key arms are bodied.
...
echo "%SRC%\SharedClasses\Traffic\BrnTrafficVehicleTraits.cpp"
  ...
  echo "%SRC%\GameSource\Game\GameBridgeDirectorToX.cpp"
  ...
  echo "%SRC%\GameSource\Gui\PFX\BrnPfxHookBlender.cpp"
  echo "%SRC%\GameSource\Gui\PFX\BrnPfxHookBlender_Fader.cpp"
  echo "%SRC%\GameSource\Gui\PFX\Resource\BrnGuiPFXHooksResource.cpp"
  ...
  echo "%SRC%\GameSource\GameState\Array_DriveThruInfo_46.cpp"
  ...
  echo "%SRC%\GameSource\GameState\ModeManager\Scoring\BrnScoringSystem_RoadRage.cpp"
  ...
  echo "%SRC%\GameSource\GameState\ModeManager\Scoring\BrnBaseOnlineModeScoring_wN1_01.cpp"
  ...
  echo "%SRC%\GameSource\GameState\RoadRules\BrnRoadRulesDebugComponent.cpp"
  echo "%SRC%\GameSource\GameState\RoadRules\BrnRoadRulesManager_wR_01.cpp"
  echo "%SRC%\GameSource\GameState\RoadRules\BrnRoadRulesManager_wR_02.cpp"
  echo "%SRC%\GameSource\GameState\RoadRules\BrnRoadRulesManager_wR_03.cpp"
  ...
  echo "%SRC%\SharedClasses\World\BrnCollisionTag.cpp"
  ...
  echo "%SRC%\GameSource\Gui\BrnGuiOverlaysDirector.cpp"
  echo "%SRC%\SharedClasses\DataLists\BrnPopupController.cpp"
  echo "%SRC%\GameShared\GameClasses\Gui\Model\Resources\CgsGuiPopupResourceType.cpp"
  ...
  echo "%SRC%\GameSource\Gui\BrnChallengeListComponent.cpp"
  ...
  echo "%SRC%\GameSource\Gui\Flow\PostEvent\States\Offline\BrnOfflineRivalShutdown.cpp"
  ...
  rem  GuiCache::GetOnlinePlayerInfoFromPlayerId, a partfile split of BrnGuiCache.cpp.
  ...
  echo "%SRC%\GameShared\GameClasses\Gui\CgsGuiEventLocalisedTextPointerRemoved.cpp"
  echo "%SRC%\GameShared\GameClasses\Network\Buddies\DirtySock\CgsBuddyManagerDirtySock.cpp"
  echo "%SRC%\GameShared\GameClasses\Network\Buddies\DirtySock\X360\CgsBuddyManagerDirtySockX360.cpp"
  echo "%SRC%\GameShared\GameClasses\Network\CgsNetworkManager.cpp"
  echo "%SRC%\GameShared\GameClasses\Network\CgsNetworkManagerPrepareParams.cpp"
  echo "%SRC%\GameShared\GameClasses\Network\CgsNetworkRankedContexts.cpp"
  echo "%SRC%\GameShared\GameClasses\Network\CgsNetworkVersionDisplay.cpp"
  echo "%SRC%\GameShared\GameClasses\Network\Debug Components\CgsNetworkHostMigrationDebugComponent.cpp"
  echo "%SRC%\GameShared\GameClasses\Network\Debug Components\CgsNetworkPlayerManagerDebugComponent.cpp"
  echo "%SRC%\GameShared\GameClasses\Network\Packeting\CgsCompressionAndEncryptionUtils.cpp"
  echo "%SRC%\GameShared\GameClasses\Network\Packeting\CgsNetworkAdapterBase.cpp"
  echo "%SRC%\GameShared\GameClasses\Network\Packeting\Messages\CgsHeadsetStatusMessage.cpp"
  echo "%SRC%\GameShared\GameClasses\Network\Packeting\Messages\CgsHostKeepAliveMessage.cpp"
  echo "%SRC%\GameShared\GameClasses\Network\Packeting\Messages\CgsHostKeepAliveMessageRetrieve.cpp"
  echo "%SRC%\GameShared\GameClasses\Network\Packeting\Messages\CgsMessage_wN1_02.cpp"
  echo "%SRC%\GameShared\GameClasses\Network\Packeting\Messages\CgsPingMessage.cpp"
  echo "%SRC%\GameShared\GameClasses\Network\Packeting\X360\CgsNetworkAdapterX360.cpp"
  echo "%SRC%\GameShared\GameClasses\Network\Players\CgsHostMigrationManager.cpp"
  echo "%SRC%\GameShared\GameClasses\Network\Players\CgsNetworkPlayer.cpp"
  echo "%SRC%\GameShared\GameClasses\Network\Players\CgsNetworkPlayer_wN2_01.cpp"
  echo "%SRC%\GameShared\GameClasses\Network\Players\CgsPlayerManager.cpp"
  echo "%SRC%\GameShared\GameClasses\Network\Players\CgsPlayerManager_wN2_01.cpp"
  echo "%SRC%\GameShared\GameClasses\Network\Players\CgsPlayerManager_wN2_02.cpp"
  echo "%SRC%\GameShared\GameClasses\Network\Players\CgsPlayerManager_wN2_03.cpp"
  echo "%SRC%\GameShared\GameClasses\Network\Players\CgsPlayerManager_wN2_04.cpp"
  echo "%SRC%\GameShared\GameClasses\Network\Players\CgsPlayersConnectionManagerLookup.cpp"
  echo "%SRC%\GameShared\GameClasses\Network\Players\CgsPlayersConnectionManager_wN2_01.cpp"
  echo "%SRC%\GameShared\GameClasses\Network\Players\CgsPlayersConnectionManager_wN2_02.cpp"
  echo "%SRC%\GameShared\GameClasses\Network\Players\CgsPlayersConnectionManager_wN2_03.cpp"
  echo "%SRC%\GameShared\GameClasses\Network\Players\CgsPlayersConnectionManager_wN2_04.cpp"
  echo "%SRC%\GameShared\GameClasses\Network\Players\CgsPlayersConnectionManager_wN2_05.cpp"
  echo "%SRC%\GameShared\GameClasses\Network\Players\CgsReliableMessageManager.cpp"
  echo "%SRC%\GameShared\GameClasses\Network\Players\CgsReliableMessageManager_wN2_01.cpp"
  echo "%SRC%\GameShared\GameClasses\Network\Players\X360\CgsUniquePlayerIDX360.cpp"
  echo "%SRC%\GameShared\GameClasses\Network\ServerInterface\DirtySock\CgsServerInterfaceDirtySock.cpp"
  echo "%SRC%\GameShared\GameClasses\Network\ServerInterface\DirtySock\CgsServerInterfaceStructureInterface.cpp"
  echo "%SRC%\GameShared\GameClasses\Network\ServerInterface\DirtySock\Components\CgsServerInterfaceBroadcastMessages.cpp"
  echo "%SRC%\GameShared\GameClasses\Network\ServerInterface\DirtySock\Components\CgsServerInterfaceComponent.cpp"
  echo "%SRC%\GameShared\GameClasses\Network\ServerInterface\DirtySock\Components\CgsServerInterfaceComponentDtor.cpp"
  echo "%SRC%\GameShared\GameClasses\Network\ServerInterface\DirtySock\Components\CgsServerInterfaceConnection.cpp"
  echo "%SRC%\GameShared\GameClasses\Network\ServerInterface\DirtySock\Components\CgsServerInterfaceCustomCommands.cpp"
  echo "%SRC%\GameShared\GameClasses\Network\ServerInterface\DirtySock\Components\CgsServerInterfaceDefaultPlayerInfoData.cpp"
  echo "%SRC%\GameShared\GameClasses\Network\ServerInterface\DirtySock\Components\CgsServerInterfaceDefaultPlayerParameters.cpp"
  echo "%SRC%\GameShared\GameClasses\Network\ServerInterface\DirtySock\Components\CgsServerInterfaceDownloadableConfig.cpp"
  echo "%SRC%\GameShared\GameClasses\Network\ServerInterface\DirtySock\Components\CgsServerInterfaceEndGameData.cpp"
  echo "%SRC%\GameShared\GameClasses\Network\ServerInterface\DirtySock\Components\CgsServerInterfaceGameFlags.cpp"
  echo "%SRC%\GameShared\GameClasses\Network\ServerInterface\DirtySock\Components\CgsServerInterfaceGameParams.cpp"
  echo "%SRC%\GameShared\GameClasses\Network\ServerInterface\DirtySock\Components\CgsServerInterfaceGameSearchParams.cpp"
  echo "%SRC%\GameShared\GameClasses\Network\ServerInterface\DirtySock\Components\CgsServerInterfaceGames.cpp"
  echo "%SRC%\GameShared\GameClasses\Network\ServerInterface\DirtySock\Components\CgsServerInterfaceGames_wN2_01.cpp"
  echo "%SRC%\GameShared\GameClasses\Network\ServerInterface\DirtySock\Components\CgsServerInterfaceHttp.cpp"
  echo "%SRC%\GameShared\GameClasses\Network\ServerInterface\DirtySock\Components\CgsServerInterfacePingRegions.cpp"
  echo "%SRC%\GameShared\GameClasses\Network\ServerInterface\DirtySock\Components\CgsServerInterfacePlayerInfo.cpp"
  echo "%SRC%\GameShared\GameClasses\Network\ServerInterface\DirtySock\Components\CgsServerInterfacePlayerInfoData.cpp"
  echo "%SRC%\GameShared\GameClasses\Network\ServerInterface\DirtySock\Components\CgsServerInterfacePlayerInfoDtor.cpp"
  echo "%SRC%\GameShared\GameClasses\Network\ServerInterface\DirtySock\Components\CgsServerInterfacePlayerParams.cpp"
  echo "%SRC%\GameShared\GameClasses\Network\ServerInterface\DirtySock\Components\CgsServerInterfacePrepareParams.cpp"
  echo "%SRC%\GameShared\GameClasses\Network\ServerInterface\DirtySock\Components\CgsServerInterfaceQuickJoinParams.cpp"
  echo "%SRC%\GameShared\GameClasses\Network\ServerInterface\DirtySock\Components\CgsServerInterfaceRankings.cpp"
  echo "%SRC%\GameShared\GameClasses\Network\ServerInterface\DirtySock\Components\CgsServerInterfaceServerInfo.cpp"
  echo "%SRC%\GameShared\GameClasses\Network\ServerInterface\DirtySock\Components\CgsServerInterfaceServerInfoDtor.cpp"
  echo "%SRC%\GameShared\GameClasses\Network\ServerInterface\DirtySock\Components\CgsServerInterfaceTelemetry.cpp"
  echo "%SRC%\GameShared\GameClasses\Network\ServerInterface\DirtySock\Components\CgsServerInterfaceUsersetFlags.cpp"
  echo "%SRC%\GameShared\GameClasses\Network\ServerInterface\DirtySock\Components\CgsServerInterfaceUsersetParams.cpp"
  echo "%SRC%\GameShared\GameClasses\Network\ServerInterface\DirtySock\Components\CgsServerInterfaceUsersets.cpp"
  echo "%SRC%\GameShared\GameClasses\Network\ServerInterface\DirtySock\X360\CgsServerInterfaceDirtySockX360.cpp"
  echo "%SRC%\GameShared\GameClasses\Network\ServerInterface\DirtySock\X360\CgsServerInterfaceGameParamsX360.cpp"
  echo "%SRC%\GameShared\GameClasses\Network\ServerInterface\DirtySock\X360\CgsServerInterfaceGamesX360.cpp"
  echo "%SRC%\GameShared\GameClasses\Network\ServerInterface\DirtySock\X360\CgsServerInterfacePlayerInfoDataX360.cpp"
  echo "%SRC%\GameShared\GameClasses\Network\ServerInterface\DirtySock\X360\CgsServerInterfacePlayerParamsX360.cpp"
  echo "%SRC%\GameShared\GameClasses\Network\ServerInterface\DirtySock\X360\CgsServerInterfaceUsersetParamsX360.cpp"
  echo "%SRC%\GameShared\GameClasses\Network\StartTime\CgsStartTimeManager.cpp"
  echo "%SRC%\GameShared\GameClasses\Network\Time\CgsReadyMessage.cpp"
  echo "%SRC%\GameShared\GameClasses\Network\Time\CgsSyncTimeBase.cpp"
  echo "%SRC%\GameShared\GameClasses\Network\Time\CgsSyncTimeClient.cpp"
  echo "%SRC%\GameShared\GameClasses\Network\Time\CgsSyncTimeHost.cpp"
  echo "%SRC%\GameShared\GameClasses\Network\Time\CgsSyncTimeMessageManager.cpp"
  echo "%SRC%\GameShared\GameClasses\Network\Time\CgsTimeManager.cpp"
  echo "%SRC%\GameShared\GameClasses\Network\VoIP\DirtySock\CgsVoIPManagerDirtySock.cpp"
  echo "%SRC%\GameShared\GameClasses\Network\VoIP\DirtySock\CgsVoIPManagerDirtySock_wN2_01.cpp"
  echo "%SRC%\GameShared\GameClasses\System\PC\BrnNetHarnessPC.cpp"
  echo "%SRC%\GameShared\Jobs\DXTCompress\CgsNetworkTextureDXTCompress.cpp"
  echo "%SRC%\GameShared\Jobs\DXTCompress\DXTCompress.cpp"
  echo "%SRC%\GameShared\Jobs\DXTCompress\DXTCompressAlgorithmFast.cpp"
  echo "%SRC%\GameShared\Jobs\DXTDecode\DXTDecode.cpp"
  echo "%SRC%\GameShared\Jobs\DXTDecode\DXTDecodeCodec.cpp"
  echo "%SRC%\GameShared\Jobs\DXTDecode\DXTDecodeJob.cpp"
  echo "%SRC%\GameSource\Game\BrnGameModule_wN1_01.cpp"
  echo "%SRC%\GameSource\Game\BrnGameModule_wN1_02.cpp"
  echo "%SRC%\GameSource\Game\GameBridgeGUIToX.cpp"
  echo "%SRC%\GameSource\Game\GameBridgeGameStateToX_wN1_01.cpp"
  echo "%SRC%\GameSource\GameFlowController\TopLevel\BrnGameMainFlowStates_wN1_01.cpp"
  echo "%SRC%\GameSource\Gui\Events\BrnGuiEventNetworkCreateGame.cpp"
  echo "%SRC%\GameSource\Network\BrnNetworkGameParams.cpp"
  echo "%SRC%\GameSource\Network\BrnNetworkGameResults.cpp"
  echo "%SRC%\GameSource\Network\BrnNetworkInEventTypeDefs.cpp"
  echo "%SRC%\GameSource\Network\BrnNetworkManager.cpp"
  echo "%SRC%\GameSource\Network\BrnNetworkManager_wN1_01.cpp"
  echo "%SRC%\GameSource\Network\BrnNetworkManager_wN1_02.cpp"
  echo "%SRC%\GameSource\Network\BrnNetworkManager_wN1_03.cpp"
  echo "%SRC%\GameSource\Network\BrnNetworkModule.cpp"
  echo "%SRC%\GameSource\Network\BrnNetworkModule_AddOutputGuiEvent_Inst.cpp"
  echo "%SRC%\GameSource\Network\BrnNetworkPlayer.cpp"
  echo "%SRC%\GameSource\Network\BrnNetworkPlayerMenuData.cpp"
  echo "%SRC%\GameSource\Network\BrnNetworkServers.cpp"
  echo "%SRC%\GameSource\Network\BrnServerInterface.cpp"
  echo "%SRC%\GameSource\Network\BrnServerInterfaceBase.cpp"
  echo "%SRC%\GameSource\Network\BrnServerInterfaceX360_wL_01.cpp"
  echo "%SRC%\GameSource\Network\BrnServerInterfaceX360_wL_02.cpp"
  echo "%SRC%\GameSource\Network\BrnServerInterfaceX360_wL_03.cpp"
  echo "%SRC%\GameSource\Network\BrnServerInterfaceX360_wL_04.cpp"
  echo "%SRC%\GameSource\Network\BrnServerInterfaceX360_wL_05.cpp"
  echo "%SRC%\GameSource\Network\Components\BrnServerInterfaceCustomCommands.cpp"
  echo "%SRC%\GameSource\Network\Components\BrnServerInterfaceDownloadableConfig.cpp"
  echo "%SRC%\GameSource\Network\Components\BrnServerInterfaceTelemetry.cpp"
  echo "%SRC%\GameSource\Network\Debug Components\BrnNetworkBuddyManagerDebugComponent.cpp"
  echo "%SRC%\GameSource\Network\Debug Components\BrnNetworkEventScoresManagerDebugComponent.cpp"
  echo "%SRC%\GameSource\Network\Debug Components\BrnNetworkImageManagerDebugComponent.cpp"
  echo "%SRC%\GameSource\Network\Debug Components\BrnNetworkLiveRevengeDebugComponent.cpp"
  echo "%SRC%\GameSource\Network\Debug Components\BrnNetworkRoadRulesManagerDebugComponent.cpp"
  echo "%SRC%\GameSource\Network\Debug Components\BrnNetworkScoreboardDebugComponent.cpp"
  echo "%SRC%\GameSource\Network\Debug Components\BrnNetworkServerInterfaceDebugComponent.cpp"
  echo "%SRC%\GameSource\Network\Debug Components\BrnNetworkStatsDebugComponent.cpp"
  echo "%SRC%\GameSource\Network\Managers\Array_LiveRevengeRelationship_250.cpp"
  echo "%SRC%\GameSource\Network\Managers\Array_LocalEventScoreUploadData_49.cpp"
  echo "%SRC%\GameSource\Network\Managers\BaseEventQueue_NetworkPlayerStats_AddEventSafe.cpp"
  echo "%SRC%\GameSource\Network\Managers\BrnChallengeSuccessManager.cpp"
  echo "%SRC%\GameSource\Network\Managers\BrnEventScoresManager.cpp"
  echo "%SRC%\GameSource\Network\Managers\BrnNetworkAggressiveDrivingManager.cpp"
  echo "%SRC%\GameSource\Network\Managers\BrnNetworkAutoLoginManager.cpp"
  echo "%SRC%\GameSource\Network\Managers\BrnNetworkBuddyManagerBase.cpp"
  echo "%SRC%\GameSource\Network\Managers\BrnNetworkConnectionManager.cpp"
  echo "%SRC%\GameSource\Network\Managers\BrnNetworkDirtyTrickManager.cpp"
  echo "%SRC%\GameSource\Network\Managers\BrnNetworkImageManager.cpp"
  echo "%SRC%\GameSource\Network\Managers\BrnNetworkInviteManager.cpp"
  echo "%SRC%\GameSource\Network\Managers\BrnNetworkLaunchManager.cpp"
  echo "%SRC%\GameSource\Network\Managers\BrnNetworkLiveRevengeManager.cpp"
  echo "%SRC%\GameSource\Network\Managers\BrnNetworkLoginManagerBase.cpp"
  echo "%SRC%\GameSource\Network\Managers\BrnNetworkMarkedManManager.cpp"
  echo "%SRC%\GameSource\Network\Managers\BrnNetworkMatchMakingManager_wN2_01.cpp"
  echo "%SRC%\GameSource\Network\Managers\BrnNetworkPlayerStatsManager.cpp"
  echo "%SRC%\GameSource\Network\Managers\BrnNetworkPlayerStatsResults.cpp"
  echo "%SRC%\GameSource\Network\Managers\BrnNetworkPostRoundManager.cpp"
  echo "%SRC%\GameSource\Network\Managers\BrnNetworkRoadRulesManager.cpp"
  echo "%SRC%\GameSource\Network\Managers\BrnNetworkRoadRulesManager_wN2_01.cpp"
  echo "%SRC%\GameSource\Network\Managers\BrnNetworkScoreboard.cpp"
  echo "%SRC%\GameSource\Network\Managers\BrnNetworkScoreboardManager.cpp"
  echo "%SRC%\GameSource\Network\Managers\BrnNetworkSelectedRoutesManager.cpp"
  echo "%SRC%\GameSource\Network\Managers\BrnNetworkStandingsManager.cpp"
  echo "%SRC%\GameSource\Network\Managers\BrnNetworkStateManager.cpp"
  echo "%SRC%\GameSource\Network\Managers\BrnNetworkStateManager_wN1_01.cpp"
  echo "%SRC%\GameSource\Network\Managers\BrnNetworkStateManager_wN1_02.cpp"
  echo "%SRC%\GameSource\Network\Managers\BrnNetworkStateManager_wN1_03.cpp"
  echo "%SRC%\GameSource\Network\Managers\BrnNetworkStateManager_wN1_04.cpp"
  echo "%SRC%\GameSource\Network\Managers\BrnNetworkStatsRequestEventQueue.cpp"
  echo "%SRC%\GameSource\Network\Managers\BrnNetworkSuspensionManager.cpp"
  echo "%SRC%\GameSource\Network\Managers\BrnNetworkTeamSelectionManager.cpp"
  echo "%SRC%\GameSource\Network\Managers\BrnNetworkTrafficManager.cpp"
  echo "%SRC%\GameSource\Network\Managers\BrnStatsRequestEvent.cpp"
  echo "%SRC%\GameSource\Network\Managers\RingBuffer_TrafficHashEntry_Push.cpp"
  echo "%SRC%\GameSource\Network\Managers\X360\BrnNetworkBuddyManagerX360.cpp"
  echo "%SRC%\GameSource\Network\Managers\X360\BrnNetworkCameraX360.cpp"
  echo "%SRC%\GameSource\Network\Managers\X360\BrnNetworkGamerCardManagerX360.cpp"
  echo "%SRC%\GameSource\Network\Managers\X360\BrnNetworkGamerPictureManagerX360.cpp"
  echo "%SRC%\GameSource\Network\Managers\X360\BrnNetworkLoginManagerX360.cpp"
  echo "%SRC%\GameSource\Network\Managers\X360\BrnNetworkNotificationManagerX360.cpp"
  echo "%SRC%\GameSource\Network\Messages\BrnActiveFburnChallengeMessage.cpp"
  echo "%SRC%\GameSource\Network\Messages\BrnAggressiveDrivingMessage.cpp"
  echo "%SRC%\GameSource\Network\Messages\BrnBurningHomeRunSwitchRunnerMessage.cpp"
  echo "%SRC%\GameSource\Network\Messages\BrnBurnoutSkillzMessage.cpp"
  echo "%SRC%\GameSource\Network\Messages\BrnCameraRequestMessage.cpp"
  echo "%SRC%\GameSource\Network\Messages\BrnCameraRequestResponseMessage.cpp"
  echo "%SRC%\GameSource\Network\Messages\BrnCameraStatusMessage.cpp"
  echo "%SRC%\GameSource\Network\Messages\BrnCarSelectMessage.cpp"
  echo "%SRC%\GameSource\Network\Messages\BrnCheckpointTriggeredMessage.cpp"
  echo "%SRC%\GameSource\Network\Messages\BrnCollectableMessage.cpp"
  echo "%SRC%\GameSource\Network\Messages\BrnCrashingTrafficMessage.cpp"
  echo "%SRC%\GameSource\Network\Messages\BrnDirtyTrickMessage.cpp"
  echo "%SRC%\GameSource\Network\Messages\BrnFburnChallengeStatusMessage.cpp"
  echo "%SRC%\GameSource\Network\Messages\BrnFburnChallengeSuccessMessage.cpp"
  echo "%SRC%\GameSource\Network\Messages\BrnFburnSuccessUpdateMessage.cpp"
  echo "%SRC%\GameSource\Network\Messages\BrnFreeburnChallengeMessage.cpp"
  echo "%SRC%\GameSource\Network\Messages\BrnHullSyncMessage.cpp"
  echo "%SRC%\GameSource\Network\Messages\BrnImageMessage.cpp"
  echo "%SRC%\GameSource\Network\Messages\BrnLiveRevengeSyncMessage.cpp"
  echo "%SRC%\GameSource\Network\Messages\BrnMarkedManMessage.cpp"
  echo "%SRC%\GameSource\Network\Messages\BrnPlayerFinishedRoundMessage.cpp"
  echo "%SRC%\GameSource\Network\Messages\BrnRestartTrafficMessage.cpp"
  echo "%SRC%\GameSource\Network\Messages\BrnRoadRulesMessage.cpp"
  echo "%SRC%\GameSource\Network\Messages\BrnRoadRulesPersonalBestMessage.cpp"
  echo "%SRC%\GameSource\Network\Messages\BrnSelectedRoutesMessage.cpp"
  echo "%SRC%\GameSource\Network\Messages\BrnShowtimeSwitchMessage.cpp"
  echo "%SRC%\GameSource\Network\Messages\BrnShowtimeUpdateMessage.cpp"
  echo "%SRC%\GameSource\Network\Messages\BrnStatsUpdateMessage.cpp"
  echo "%SRC%\GameSource\Network\Messages\BrnStuntMultiplierMessage.cpp"
  echo "%SRC%\GameSource\Network\Messages\BrnStuntScoreUpdatedMessage.cpp"
  echo "%SRC%\GameSource\Network\Messages\BrnTeamSelectMessage.cpp"
  echo "%SRC%\GameSource\Network\Messages\BrnTrafficHashMessage.cpp"
  echo "%SRC%\GameSource\Network\Messages\BrnUpdateMessage_wN1_01.cpp"
  echo "%SRC%\GameSource\Network\Parameters\BrnNetworkEventScoreData.cpp"
  echo "%SRC%\GameSource\Network\Parameters\BrnNetworkGameSearchParams.cpp"
  echo "%SRC%\GameSource\Network\Parameters\BrnNetworkGameSearchParamsDtor.cpp"
  echo "%SRC%\GameSource\Network\Parameters\BrnNetworkParameterData.cpp"
  echo "%SRC%\GameSource\Network\Parameters\BrnNetworkPlayerInfoData.cpp"
  echo "%SRC%\GameSource\Network\Parameters\BrnNetworkPlayerParams.cpp"
  echo "%SRC%\GameSource\Network\Parameters\BrnNetworkPlayerParamsClass.cpp"
  echo "%SRC%\GameSource\Network\Parameters\BrnNetworkQuickJoinParams.cpp"
  echo "%SRC%\GameSource\Network\Parameters\BrnNetworkRoadRulesData.cpp"
  echo "%SRC%\GameSource\Network\Parameters\BrnNetworkUsersetParams.cpp"
  echo "%SRC%\GameSource\Network\SharedIO\BaseEventQueue_DirtyTrickEvent_GetEvent.cpp"
  echo "%SRC%\GameSource\Network\SharedIO\BaseEventQueue_RoadRulesDownloadEvent_AppendAddEvent.cpp"
  echo "%SRC%\GameSource\Network\SharedIO\BrnNetworkOutGameParamsChanged.cpp"
  echo "%SRC%\GameSource\Network\SharedIO\BrnNetworkOutPlayerEvents.cpp"
  echo "%SRC%\GameSource\Network\SharedIO\BrnNetworkSharedIO.cpp"
  echo "%SRC%\GameSource\Network\SharedIO\EventQueue_DirtyTrickEvent_28.cpp"
  echo "%SRC%\GameSource\Network\SharedIO\EventQueue_NetworkToGuiLiveRevengeUpdate_4.cpp"
  echo "%SRC%\GameSource\Network\SharedIO\EventQueue_RoadRulesDownloadEvent_40.cpp"
  echo "%SRC%\GameSource\Network\SharedIO\EventQueue_RoadRulesMessageData_40.cpp"
  ...
  echo "%SRC%\GameSource\GameState\StreetData\BrnGameStateStreetManager_wB_04.cpp"
  echo "%SRC%\GameSource\GameState\StreetData\BrnGameStateStreetManager_wB_05.cpp"
  echo "%SRC%\GameSource\GameState\StreetData\BrnGameStateStreetManager_wB_06.cpp"
  echo "%SRC%\GameSource\GameState\StreetData\BrnGameStateStreetManager_wB_07.cpp"
  echo "%SRC%\GameSource\GameState\StreetData\BrnGameStateStreetManager_wC_00.cpp"
  echo "%SRC%\GameSource\GameState\StreetData\BrnGameStateStreetManager_wC_02.cpp"
  echo "%SRC%\GameSource\GameState\StreetData\BrnGameStateStreetManager_wC_03.cpp"
  echo "%SRC%\GameSource\GameState\StreetData\BrnGameStateStreetManager_wR_01.cpp"
  echo "%SRC%\GameSource\GameState\StreetData\BrnGameStateStreetManager_wR_10.cpp"
  echo "%SRC%\GameSource\GameState\StreetData\BrnGameStateStreetManager_wR_11.cpp"
  echo "%SRC%\GameSource\GameState\StreetData\BrnStreetManagerDebugComponent_wO_01.cpp"
  echo "%SRC%\GameSource\GameState\AchievementManager\BrnGameStateAchievementManagerBase_RoadRules.cpp"
...
:driver_compile
%PY_CMD% "%~dp0compile_exe.py" --base "%BASERSP%" --rsp "%RSP%" --out "%OUT%" -- /SUBSYSTEM:WINDOWS /MAP /OPT:REF /LIBPATH:"%FFM%\bin" "%OUT%\obj\burnout.res" d3d9.lib user32.lib gdi32.lib gdiplus.lib kernel32.lib ntdll.lib winmm.lib shell32.lib ole32.lib advapi32.lib ws2_32.lib avformat.lib avcodec.lib avutil.lib swscale.lib swresample.lib "%VEN%\lua\lua515.lib"
